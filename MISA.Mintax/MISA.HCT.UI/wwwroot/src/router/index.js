...
export const routes = [
  ...
  },
  {
    path: "/tax-deduction",
    component: Layout,
    redirect: { name: "TaxDeduction" },
    children: [
      {
        path: "",
        name: "TaxDeduction",
        component: () => import("@/views/tax-deduction/index.vue"),
      },
      {
        path: "/dependent-person-detail",
        name: "DependentPersonDetail",
        meta: {
          title: "Công ty cổ phẩn MISA",
          isBack: true,
        },
        component: () =>
          import("@/views/tax-deduction/dependent-person-detail/index.vue"),
      },
    ],
  },
