<template>
  <div :class="{ hidden: hidden }" class="pagination-container">
    ...
    />
    <div class="page-show">
      Hiển thị {{ startindex }} - {{ startend }}/{{ getTotal }}
      {{ getTypepage }}
    </div>
    <el-button
      :id="getBackdb"
    ...
    <el-button
      ...
      @click="nextend"
      :style="getStylenext"
      :disabled="page * limit >= total ? true : false"
    >
      <img class="img-nextbd" src="@/icons/Group 17472@2x.png" />
    </el-button>

    <div class="page-size-show d-flex">Hiển thị số bản ghi/trang
    </div>
  </div>
</template>
...
// import inputDropdown from "@/components/select"
/**
...
export default {
  ...
  methods: {
    ...
    nextend() {
      ...
      if (number * this.limit != this.total) {
        number = number + 1;
      }
