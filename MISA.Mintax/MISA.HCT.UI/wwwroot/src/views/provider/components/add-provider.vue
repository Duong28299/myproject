            ...
            >
                <el-row>
                    <el-col :lg="24" :md="24" :sm="24">
                        <h2 style="font-size:15px">THÔNG TIN CƠ BẢN</h2>
                    </el-col>
                    <el-col :lg="24" :md="24" :sm="24">
                        <el-row :gutter="16">
                    ...
                    <el-col :lg="24" :md="24" :sm="24">
                        <h2 style="font-size:15px">THÔNG TIN NGƯỜI LIÊN HỆ</h2>
                    </el-col>
                    <el-col :lg="24" :md="24" :sm="24">
                        <el-row :gutter="16">
                            <el-col :lg="12" :md="12" :sm="24">
                                ...
                                >
                                    <el-row >
                                        <el-col :lg="8" :md="8" :sm="8" class="gender">
                                            <provider-select
                                            id="Gender"
                                            type="label-top"
                                            label="label"
                                            field="value"
                                            :defaultNumber="formProviverOrganization.Gender"
                                            :list="Sex"
                                            @value="formProviverOrganization.Gender = $event"
                                        ></provider-select>
                                        </el-col>
                                        <el-col :lg="16" :md="16" :sm="16" class="name">
                                            <field-input
                                            id="ContactName"
                                            :width="'100%'"
                                            type="field-input"
                                ...
                                >
                                    <el-row>
                                        <el-col :lg="8" :md="8" :sm="8" class="gender">
                                            ...
                                            label="label"
                                            field="value"
                                            :defaultNumber="formProviverPersonal.Gender"
                                            :list="Sex"
                                            @value="formProviverPersonal.Gender = $event"
                                        ></provider-select>
                                        </el-col>
                                        <el-col :lg="16" :md="16" :sm="16" class="name">
                                            <field-input
        ...
        async addProvider(){
            ...
            this.$refs[formName].validate(async (valid, index) => {
                ...
                if(valid){
                    ...
                    if(!res.data.Success){
                        if(res.data.MISACode == MISA_CODE.ValidateEntity)
                            this.$_Notification.error("Lỗi","Lỗi dữ liệu.");
                        else if(res.data.MISACode == MISA_CODE.Duplicate){
                            if(this.formPersonal==0){
                                this.popUpWarnDuplicateDependent(`Nhà cung cấp ${this.formProviverOrganization.ProviderCode} đã tồn tại. Bạn vui lòng kiểm tra lại.`)

                            }else{
                                this.popUpWarnDuplicateDependent(`Nhà cung cấp ${this.formProviverPersonal.ProviderCode} đã tồn tại. Bạn vui lòng kiểm tra lại.`)
                            }
                        }else if(res.data.MISACode == MISA_CODE.ErrorAddEntity){
                        ...
                        else if(res.data.MISACode == MISA_CODE.ErrorUpdateEntity)
       ...
       */
        mapDataToForm(val){
            ...
            if(val.ProviderType==1){
                ...
                this.formProviverPersonal.Gender = val["Gender"]
    ...
    watch:{
        ...
        modeDuplicate:{
            handler(val){
                if(val){
                   this.getProviderByID();
                    this.title = "Nhân bản nhà cung cấp"
                }else
                    this.title = "Thêm nhà cung cấp"
            }
        },
        ...
        "formProviverPersonal.Debt":{
            handler(val){
                this.formProviverPersonal.Debt = val.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
...
#provider-dialog{
    ...
    @media screen and (max-width:992px) and (min-height: 768px) {
        .el-dialog{
            width: 750px !important;
            .el-dialog__body{
                height: 550px;
    ...
    @media screen and (max-width:992px) and (max-height: 767px) {
        .el-dialog{
            width: 750px !important;
            .el-dialog__body{
                height: 450px;
    ...
    @media screen and (max-width:992px) and (max-height:580px) {
        .el-dialog{
            width: 750px !important;
            .el-dialog__body{
                height: 370px;
    ...
    @media screen and (max-width:992px) and (max-height:439px) {
        .el-dialog{
            width: 750px !important;
            .el-dialog__body{
                height: 260px;
