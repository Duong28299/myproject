...
using MISA.Mintax.ETax.Api.Middleware;
using MISA.Mintax.ETax.Api.Services;
using MISA.Mintax.ETax.ApplicationCore.Entities;
using MISA.Mintax.ETax.Infrastructure.Data;
using MISA.Mintax.ETax.Infrastructure.Data.Repositories;
using MISA.Mintax.ETax.Infrastructure.DatabaseContext;
using MISA.Mintax.ETax.Infrastructure.UnitOfWork;
using Newtonsoft.Json;
using Newtonsoft.Json.Serialization;
using MISA.Mintax.ETax.ApplicationCore.Entities.Mapping;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
           DatabaseContext.ConnectionString = Configuration.GetConnectionString("MintaxConnection");
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "MISA.Mintax Etax Service", Version = "v1" });
            });
		...
		public void Configure(IApplicationBuilder app, IWebHostEnvironment env, IDistributedCache distributedCache)
        {
			...
			//		actionResult.Message = MISA.Mintax.ETax.ApplicationCore.Properties.Resources.ValidateEntity;
